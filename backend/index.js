...
const fetchUser = async (req, res, next) => {
  ...
  if (!token) {
    ...
    try {
      ...
      res.status(401).send({ errors: 'please auth ising a valid token' });
    }
  }
};

// create andpoint for add products in cart
...
// creat andpoint to remove product from cart data
...
// create andpoint to get cart data
